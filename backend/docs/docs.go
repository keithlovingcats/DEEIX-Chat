...
const docTemplate = `{
    ...
    "paths": {
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/GlobalChatMessageDeleteResponseDoc"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/global-chat/files/{file_id}/content": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/GlobalChatMessageListResponseDoc"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/GlobalChatMessageResponseDoc"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/GlobalChatOnlineCountResponseDoc"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
        ...
        "/global-chat/stream": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "已接收的最后消息自增 ID（断线重连补全）",
                        "name": "after_id",
                        "in": "query"
                    }
                ],
    ...
    "definitions": {
        ...
        "GlobalChatMessageDataResponse": {
            ...
            "properties": {
                "message": {
                    "$ref": "#/definitions/GlobalChatMessageResponse"
                }
            }
        },
        "GlobalChatMessageDeleteDataResponse": {
            "type": "object",
            "required": [
                "deleted"
            ],
        ...
        "GlobalChatMessageDeleteResponseDoc": {
            "type": "object",
            "required": [
                "data",
                "errorMsg"
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/GlobalChatMessageDeleteDataResponse"
                },
                "errorMsg": {
                    "type": "string"
                }
        ...
        "GlobalChatMessageListResponseDoc": {
            "type": "object",
            "required": [
                "data",
                "errorMsg"
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/GlobalChatMessageListData"
                },
                "errorMsg": {
                    "type": "string"
                }
        ...
        "GlobalChatMessageResponseDoc": {
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/GlobalChatMessageDataResponse"
                },
                "errorMsg": {
                    "type": "string"
                }
        ...
        "GlobalChatOnlineCountResponseDoc": {
            "type": "object",
            "required": [
                "data",
                "errorMsg"
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/GlobalChatOnlineCountDataResponse"
                },
                "errorMsg": {
                    "type": "string"
                }
