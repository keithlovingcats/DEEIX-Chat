...
var (
	...
	ErrMessageDeleteTargetInvalid = apperr.NewMasked("message.delete_target_invalid", "message delete target invalid", "invalid message delete target")
	// ErrMessageDeleteTargetActive 删除目标仍在生成中，不允许删除。
	ErrMessageDeleteTargetActive = apperr.NewMasked("message.delete_target_active", "message is still generating", "message delete target active")
