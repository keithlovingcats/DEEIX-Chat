...
import enGlobalChat from "@/i18n/messages/en-US/global-chat.json";
...
import enNotes from "@/i18n/messages/en-US/notes.json";
...
export async function loadLocaleMessages(locale: AppLocale): Promise<AppMessages> {
  ...
  const [
    ...
    import("@/i18n/messages/zh-CN/notes.json"),
    ...
    import("@/i18n/messages/zh-CN/global-chat.json"),
